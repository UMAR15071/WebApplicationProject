...
$sql = "SELECT Course_ID, Course_Name, Course_Provider,Course_Description, Course_fee, Venue, Commence_Date, Number_Of_Days, Start_Time, End_Time FROM Courses WHERE Deleted_Course = 0 AND Seats_Remaining != 0";
